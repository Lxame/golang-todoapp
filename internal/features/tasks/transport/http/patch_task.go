...
import (
	...
	core_http_types "github.com/Lxame/golang-todoapp/internal/core/transport/http/types"
)
...
// @Description 2. **Явно передано значание**: `"description":"Сделать уборку в субботу"` - устанавливает новое описание задачи
...
// @Param       request body     PatchTaskRequest   true          "PatchTask тело запросв"
...
func taskPatchFromRequest(request PatchTaskRequest) core_domain.TaskPatch {
	return core_domain.NewTaskPatch(
