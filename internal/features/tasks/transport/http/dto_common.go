...
type TaskDTOResponse struct {
	...
	Description  *string    `json:"description"    example:"Сделать домашку по метаматике до четверга"`
	Completed    bool       `json:"completed"      example:"false"`
	CreatedAt    time.Time  `json:"created_at"     example:"2026-01-02T12:30:00Z"`
...
func taskDTOsFromDomains(tasks []core_domain.Task) []TaskDTOResponse {
