...
const docTemplate = `{
        ...
        "/statistics": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Конец промежутка рассмотрения статисикик (не включительно), формат: YYYY-MM-DD",
                        "name": "to",
                        "in": "query"
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_Lxame_golang-todoapp_internal_core_transport_http_response.ErrorResponse"
                        }
                    },
                    "500": {
        ...
        "/tasks/{id}": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "PatchTask тело запросв",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/users": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Размер страницы с пользователям",
                        "name": "limit",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Смещение страницы с пользователям",
                        "name": "offset",
                        "in": "query"
                    }
                ],
    ...
    "definitions": {
        "github_com_Lxame_golang-todoapp_internal_core_transport_http_response.ErrorResponse": {
            "type": "object",
            "properties": {
                "error": {
                    "type": "string",
        ...
        "internal_features_tasks_transport_http.CreateTaskRequest": {
            ...
            "properties": {
                ...
                "description": {
                    ...
                    "maxLength": 1000,
                    "minLength": 1,
                    "example": "Сделать домашнее задание по математике до четверга"
                },
                "title": {
                    "type": "string",
                    "maxLength": 100,
        ...
        "internal_features_tasks_transport_http.CreateTaskResponse": {
            ...
            "properties": {
                ...
                "created_at": {
                    "type": "string",
                    "example": "2026-01-02T12:30:00Z"
                },
                "description": {
                    "type": "string",
                    "example": "Сделать домашку по метаматике до четверга"
                },
                "id": {
                    "type": "integer",
                    "example": 1
